...
carpeta_origen = './ajuste_SEIR_casos_argentina/'
archivo_origen = 'SEIR_casos_argentina.csv'
carpeta_destino = carpeta_origen
archivo_destino = 'ajuste_SEIR_casos_argentina.csv'
imagen_destino_casos = 'ajuste_SEIR_casos_argentina.png'
imagen_destino_casos_log = 'ajuste_SEIR_casos_argentina_log.png'
imagen_destino_R0 = 'ajuste_SEIR_casos_argentina_R0.png'
...
ajuste_paso1 = ajuste_por_periodos(modelo_SEIR, datos_iniciales, serie_estimados, serie_observados, serie_parametro, duracion_periodo, variacion_aleatoria)
...
ajuste_paso2 = ajuste_global(modelo_SEIR, ajuste_paso1, serie_estimados, serie_observados, serie_parametro, duracion_periodo, variacion_aleatoria)
